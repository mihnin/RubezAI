...
It is synchronized with `CLAUDE.md`; when one changes, update the other in the same iteration.
...
- **После завершения итерации обновлять `CLAUDE.md`, `AGENTS.md` и `docs/PLAN.md`.**
