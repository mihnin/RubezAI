...
- Итерации идут автономно, без паузы на подтверждение пользователя. При оценке
  архитектора < 9/10 — доработка и повторное ревью того же шага.
...
Итерации 0 (9.5/10), 1 (9/10), 2 (9/10) приняты архитектором.
Следующая — Итерация 3 (sanitizer: детекторы секретов и коммерческих данных).
