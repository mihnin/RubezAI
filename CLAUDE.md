...
Итерации 0–6 приняты архитектором; Итерации 4–6 доведены до 10/10
(весь технический долг устранён). Следующая — Итерация 7 (LLM Router:
mock + OpenAI-совместимый адаптер, `/api/models`).
