...
### ☐ Итерация 1 — Схема БД и миграции
...
### ☐ Итерация 2 — Sanitizer: детекторы ПДн
...
- **Цель:** обратимая псевдонимизация (`ФИО_001`, `ДОГОВОР_014`), NER-интерфейс с mock, эндпойнт `/sanitize/preview`, шифрование mapping'ов (AES-GCM).
